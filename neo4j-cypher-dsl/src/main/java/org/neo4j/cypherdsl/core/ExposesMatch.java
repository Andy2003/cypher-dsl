...
public interface ExposesMatch {
	 ...
	 */
	@NotNull @CheckReturnValue
	default StatementBuilder.OngoingReadingWithoutWhere match(@NotNull Collection<? extends PatternElement> pattern) {
	 ...
	 */
	@NotNull @CheckReturnValue
	default StatementBuilder.OngoingReadingWithoutWhere optionalMatch(@NotNull Collection<? extends PatternElement> pattern) {
